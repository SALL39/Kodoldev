  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <div>
          <span className="text-sm font-medium">Information génétique:</span>
          <p className="text-sm text-gray-600">
            Race: {healthRecord.genetic_info.breed || 'Non spécifiée'}
            {healthRecord.genetic_info.birth_weight && (
              <span className="ml-2">
                - Poids naissance: {healthRecord.genetic_info.birth_weight} kg
              </span>
            )}
          </p>
        </div>
