  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border p-6 space-y-6">
      ...
      <div className="space-y-6">
        <VaccinationHistory vaccinations={healthRecord.vaccination_history} />
        <MedicalHistory entries={healthRecord.medical_history} />
        <GeneticInfo info={healthRecord.genetic_info} />
      </div>
